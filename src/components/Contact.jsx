  ...
  return (
    <section id='contact' className="section">
        ...
        ">
            ...
            <form action="https://getform.io/f/bejrzwda" method="POST" className='xl:pl-10 2xl:pl-20'>
                <div className="
                  md:grid md:items-center md:grid-cols-2 md:gap-2
                ">
                    <div className='mb-4'>
                        <label htmlFor="name" className='label reveal-up'>Name</label>
                        <input type="text" name="name" id="name" autoComplete='name' required placeholder='sanith garipalli' className='text-field reveal-up' />
                    </div>

                    <div className='mb-4'>
                        <label htmlFor="email" className='label reveal-up'>Email</label>
                        <input type="text" name="email" id="email" autoComplete='email' required placeholder='sanith.garipalli@example.com' className='text-field reveal-up' />
                    </div>
                </div>
                <div className="mb-4">
